...
class CustomCollectionViewDataSource<T: CustomCollectionViewCell>: NSObject, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    // MARK: - Initializer
    init(items: [T.CellViewModel], collectionView: UICollectionView, delegate: CustomCollectionViewDelegate) {
        self.items = items
    ...
    func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        let cell = cell as! T
        if selectItem != nil, selectItem == indexPath {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        let baseCell = collectionView.dequeueReusableCell(withReuseIdentifier: String.init(describing: T.self), for: indexPath)
    ...
    public func newItemsToCollectionView( _ allItems: [T.CellViewModel]) {
        self.items = allItems
        self.collectionView.reloadData()
    }
    
    public func select(item: IndexPath) {
